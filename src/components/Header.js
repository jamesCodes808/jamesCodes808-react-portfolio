  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/jamesCodes808/jamesCodes808-react-portfolio" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
